  ...
  <nav rel="noopener noreferrer">
    <div className="nav-wrapper headernav head " id='intro_header'>
      ...
      <ul id="nav-mobile" className="right hide-on-med-and-down">
        <li ><a id = "link_Contact" href="files/Hernandez_Derek_James_Resume.pdf"  rel="noopener noreferrer" target="_blank" className="tooltipped" data-position="bottom" data-tooltip="Up-To date Resume "> Resume</a></li>
